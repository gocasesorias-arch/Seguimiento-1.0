...
export const obtenerColorEstado = (estado) => {
  const colores = {
    ...
    'Planificación': 'bg-blue-100 text-blue-800 border-blue-300',
    'En Proceso': 'bg-indigo-100 text-indigo-800 border-indigo-300',
    'Programado': 'bg-yellow-100 text-yellow-800 border-yellow-300',
    'En Ejecución': 'bg-orange-100 text-orange-800 border-orange-300',
    'Realizado': 'bg-green-100 text-green-800 border-green-300',
    'Cierre': 'bg-teal-100 text-teal-800 border-teal-300',
