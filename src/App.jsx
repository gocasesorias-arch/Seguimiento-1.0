        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 space-y-5">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-teal-600 text-white flex items-center justify-center text-lg">
                🎓
              </div>
              <div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button
                type="button"
                onClick={() => window.location.reload()}
                className="px-3 py-1 rounded-full text-xs font-semibold bg-teal-600 text-white hover:bg-teal-700 transition-colors"
              >
                🔄 Recargar
              </button>
            </div>
